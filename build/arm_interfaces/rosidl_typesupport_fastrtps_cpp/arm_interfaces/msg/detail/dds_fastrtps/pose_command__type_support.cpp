...
#include "arm_interfaces/msg/detail/pose_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const arm_interfaces::msg::PoseCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  arm_interfaces::msg::PoseCommand & ros_message)
{
  // Member: x
  cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = arm_interfaces::msg::PoseCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const arm_interfaces::msg::PoseCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<arm_interfaces::msg::PoseCommand *>(
    untyped_ros_message);
...
{
  return &arm_interfaces::msg::typesupport_fastrtps_cpp::_PoseCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, arm_interfaces, msg, PoseCommand)() {
  return &arm_interfaces::msg::typesupport_fastrtps_cpp::_PoseCommand__handle;
}
